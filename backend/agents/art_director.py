...
class ArtDirectorAgent(Agent):
    ...
    def _evaluate_images_vision(
        ...
        eval_prompt = (
            ...
            "6. muffin_pan_form - THE BRAND CHECK. Does the food unmistakably show the "
            "muffin-cup FORM — individual round portions with molded, slightly flared, "
            "ridged cup sides? A single portion plated out of the tin scores full marks "
            "as long as the molded cup shape is obvious; the muffin tin does NOT need to "
