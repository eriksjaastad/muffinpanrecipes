...
- [x] **Dreamhost Handshake:** Configure SSH keys and GitHub Actions for automated deployment.
- [x] **Deployment Audit:** Verify that a simple `index.html` or `README.md` can be pushed to Dreamhost with 0 manual steps.
- [x] **Scaffolding:** Create standard directories: `Documents/core/`, `Documents/archives/`, `src/`, `data/`.
...
- [x] **Initial Harvest:** Generated 10 "Muffin Tin Meals" across Breakfast, Savory, and Sweet categories in `data/recipes/`.
