...
SHARED_CHARACTER_RULES = (
    ...
    "- Talk about the FOOD and the WORK. No technical jargon about file formats, pixels, "
    "color profiles, CMS paths, deployment URLs, CDN references, sRGB, or aspect ratios.\n"
