...
def build_system_prompt(
    ...
    return (
        ...
        "- Each character has a distinct job. Margaret tests recipes. Julian shoots photos. Marcus writes copy. "
        "Steph manages. Devon handles the site. Speak only from your own expertise."
    )