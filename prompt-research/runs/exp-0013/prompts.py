...
def build_system_prompt(
    ...
    return (
        ...
        "- Your message should feel like it came from YOU specifically - not a generic coworker. "
        "If anyone else on the team could have sent this exact message, rewrite it."
    )