...
def format_highlights(highlights: list[str]) -> str:
    ...
    open_thread_lines = []
    unresolved_markers = [
        "still open", "unresolved", "disagree", "debate",
    ...
    # Assemble final output - keep it clean and focused
    # The injection template + open threads + character positions is enough
    # Avoid over-loading with extra blocks that dilute the signal
