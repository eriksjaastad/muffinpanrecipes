...
def format_highlights(highlights: list[str]) -> str:
    ...
    # Build a character-centric view: who championed what across the week
    # Parse sentences from summaries looking for name-anchored positions
    ...
    for h in highlights:
        ...
        for sentence in sentences:
            if "still open" in sentence.lower():
                continue
    ...
    # Build the final injection — keep it focused and not overwhelming
    ...
    if char_lines:
        ...
        return base_injection + char_block
