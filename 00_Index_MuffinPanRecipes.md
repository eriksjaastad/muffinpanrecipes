...
| [idea-jar/](idea-jar/) | 1 | No description available. |
...
| [DIRECTION.md](DIRECTION.md) | An AI-driven content platform disguised as a recipe website. A fictional bakery team (AI characters ... |
...
| [GEN-LOOP-BLOCKERS.md](GEN-LOOP-BLOCKERS.md) | - `uv run pytest tests/test_scripts.py` failed even with `UV_CACHE_DIR=$TMPDIR/uv-cache`: uv panicke... |
...
| [PLAN_KANBAN_PROMPTS_PHASE1.md](PLAN_KANBAN_PROMPTS_PHASE1.md) | PLAN_KANBAN_PROMPTS_PHASE1 |
| [PLAN_KANBAN_PROMPTS_PHASE2.md](PLAN_KANBAN_PROMPTS_PHASE2.md) | PLAN_KANBAN_PROMPTS_PHASE2 |
| [PLAN_KANBAN_PROMPTS_PHASE3.md](PLAN_KANBAN_PROMPTS_PHASE3.md) | PLAN_KANBAN_PROMPTS_PHASE3 |
...
| [backend/utils/image_generation.py](backend/utils/image_generation.py) | Image generation helpers for provider comparisons (Stability + Nano Banana). |
...
| [backend/utils/qa_scoring.py](backend/utils/qa_scoring.py) | QA scoring re-exports for backend use. |
| [backend/utils/recipe_prompts.py](backend/utils/recipe_prompts.py) | Recipe and description generation via model router. |
| [backend/utils/text_sanitize.py](backend/utils/text_sanitize.py) | Text sanitization for recipe content before HTML rendering. |
| [idea-jar/001-hiring-arc-social-media-manager.md](idea-jar/001-hiring-arc-social-media-manager.md) | **Added:** 2026-03-17 |
